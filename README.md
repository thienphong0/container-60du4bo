...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-60du4bo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-60du4bo.containers.anotherwebservice.com/
...
```
git clone git@github.com:thienphong0/container-60du4bo.git
cd container-60du4bo
```
...
```
docker attach container-60du4bo
```
